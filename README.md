...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-adk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-adk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install google-adk
```
...
It is possible to list all of the versions of `google-adk` available on your platform:
...
```
pixi search google-adk --channel conda-forge
```
